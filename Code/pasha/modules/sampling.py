    ...
    def pos_sample(self,batch,**kwargs):
        ...
        if self.loss["C"] == "Adj" and self.loss["Name"] == "LINE":
                ...
                for i, l in enumerate(length):
                    ...
                    mask1.t()[:(i+1)] = 1
                    mask_rw.append(mask1)
                mask_rw = torch.cat(mask_rw)
                mask_new = 1 - mask_rw
                A = self.find_sim_rank_for_batch_torch(batch,ASparse,device,mask_rw,mask_new,r)
                    ...
                    print('PPR counting',datetime.now()-d)
      ...
      #  p = 0 
        ...
        print('converting',datetime.now()-d)
